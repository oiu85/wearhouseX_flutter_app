...
class ErrorMessageHelper {
  ...
  static String getFriendlyErrorMessage(String? rawError) {
    ...
    if (lowerError.contains('server error') || lowerError.contains('internal error')) {
      return 'Server error occurred. Please try again later.';
    }
    ...
    final containsTechnicalTerms = technicalTerms.any((term) => lowerError.contains(term));
  ...
  static String getLottiePath(ErrorType errorType) {
    switch (errorType) {
      case ErrorType.noInternet:
        return Assets.images.lottie.noInternet;
      case ErrorType.timeout:
        return Assets.images.lottie.timeout;
      case ErrorType.notFound:
        return Assets.images.png.noDataWhite.path;
      case ErrorType.generic:
        // Use Connecting.json for server errors and generic errors
        return Assets.images.lottie.connnecting;
    }
  }
}
...
class _UiHelperStatusState extends State<UiHelperStatus> {
  ...
  Widget _buildErrorAnimation(double size) {
    ...
    // Use Lottie for noInternet, timeout, and generic (server errors)
    // Use Image for notFound errors
...
class CompactLottieAnimation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Lottie.asset(
        Assets.images.lottie.greenCalculator,
        width: animationSize,
...
class NoDataWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final imagePath = isDark
        ? Assets.images.png.noDataDark.path
